Write-Host "Installing NUnit 3.4.0..." -ForegroundColor Cyan -NoNewline
...
# nunit
$zipPath = "$($env:TEMP)\NUnit-3.4.0.zip"
(New-Object Net.WebClient).DownloadFile('https://github.com/nunit/nunit/releases/download/3.4.0/NUnit-3.4.0.zip', $zipPath)
